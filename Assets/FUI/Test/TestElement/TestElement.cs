...
namespace Test.Command
{
    ...
    public class TestElementViewModel : ViewModel
    {
        ...
        [Binding("TestImage", nameof(ImageElement.SpriteSources))]
        [Binding("TestImageSrc", nameof(TextElement.Text))]
        public string Image { get; set; } = "testIcon1";

        [Binding("TestRawImage", nameof(RawImageElement.TextureSources))]
        ...
        [Binding("TestDropdown", nameof(DropdownElement.Value), bindingType:BindingType.TwoWay)]
        ...
        [Binding("TestInput", nameof(InputFieldElement.Text), bindingType:BindingType.TwoWay)]
        ...
        [Binding("TestSlider", nameof(SliderElement.Value), bindingType:BindingType.TwoWay)]
        ...
        [Binding("TestScrollbar", nameof(ScrollbarElement.Value), bindingType: BindingType.TwoWay)]
        ...
        [Binding("TestToggle", nameof(ToggleElement.IsOn), bindingType: BindingType.TwoWay)]
