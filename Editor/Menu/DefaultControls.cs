...
//This file was modified from UnityEngine.UI.DefaultControls
...
namespace FUI.Editor
{
    ...
    public static class DefaultControls
    {
        ...
        {
            GameObject panelRoot = CreateUIElementRoot("Panel", s_ThickElementSize, typeof(Image), typeof(ImageElement));
        ...
        {
            GameObject buttonRoot = CreateUIElementRoot("Button (Legacy)", s_ThickElementSize, typeof(Image), typeof(Button), typeof(ImageElement), typeof(ButtonElement));

            GameObject childText = CreateUIObject("Text (Legacy)", buttonRoot, typeof(Text), typeof(TextElement));
        ...
        {
            GameObject go = CreateUIElementRoot("Text (Legacy)", s_ThickElementSize, typeof(Text), typeof(TextElement));
        ...
        {
            GameObject go = CreateUIElementRoot("Image", s_ImageElementSize, typeof(Image), typeof(ImageElement));
            return go;
        }
        ...
        {
            GameObject go = CreateUIElementRoot("RawImage", s_ImageElementSize, typeof(RawImage), typeof(RawImageElement));
            return go;
        }
        ...
        public static GameObject CreateSlider(Resources resources)
        {
            ...
            GameObject root = CreateUIElementRoot("Slider", s_ThinElementSize, typeof(Slider), typeof(SliderElement));
        ...
        {
            // Create GOs Hierarchy
            GameObject scrollbarRoot = CreateUIElementRoot("Scrollbar", s_ThinElementSize, typeof(Image), typeof(Scrollbar), typeof(ImageElement), typeof(ScrollbarElement));
        ...
        {
            // Set up hierarchy
            GameObject toggleRoot = CreateUIElementRoot("Toggle", s_ThinElementSize, typeof(Toggle), typeof(ToggleElement));
        ...
        {
            GameObject root = CreateUIElementRoot("InputField (Legacy)", s_ThickElementSize, typeof(Image), typeof(InputField), typeof(ImageElement), typeof(InputFieldElement));
        ...
        {
            GameObject root = CreateUIElementRoot("Dropdown (Legacy)", s_ThickElementSize, typeof(Image), typeof(Dropdown), typeof(ImageElement), typeof(DropdownElement));
        ...
        {
            GameObject root = CreateUIElementRoot("Scroll View", new Vector2(200, 200), typeof(Image), typeof(ScrollRect), typeof(ScrollRectElement));
