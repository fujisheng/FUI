...
namespace FUI.Manager
{
    struct UIStackItem
    {
        ...
        internal UIStackItem(UIEntity entity, string parent, object @param)
        {
            Entity = entity;
    ...
    class UIStack
    {
        ...
        internal void Push(UIEntity entity, string parent = null, object param = null)
        {
            stack.Add(new UIStackItem(entity, parent, param));
        }
        ...
        /// <param name="entityName">UI实体名</param>
        /// <returns></returns>
        internal UIStackItem GetUIStackInfo(string entityName)
        {
            return stack.Find(v => v.Entity.Name == entityName);
        }
