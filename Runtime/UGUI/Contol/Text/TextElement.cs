...
namespace FUI.UGUI.Control
{
    public class TextElement : UIElement<IText>
    {
        ...
        /// 文本对齐方式
        /// </summary>
        public BindableProperty<TextAnchor> Alignment { get; private set; }
        ...
        protected override void OnInitialize()
        {
            ...
            Alignment = new BindableProperty<TextAnchor>(Component.Alignment, (oldValue, newValue) => Component.Alignment = newValue);
        }
